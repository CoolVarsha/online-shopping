					...
					<div id="carousel-example-generic" class="carousel slide"
						...
						<div class="carousel-inner">
							...
							<div class="item active">
								<img class="slide-image" src="${images}/banners/banner1.jpg"
									alt="">
							</div>
							<div class="item">
								<img class="slide-image" src="${images}/banners/banner2.jpg"
									alt="">
							</div>
							<div class="item">
								<img class="slide-image" src="${images}/banners/banner3.jpg"
									alt="">
							</div>
							<div class="item">
								<img class="slide-image" src="${images}/banners/banner4.jpg"
									alt="">
							</div>
						</div>
